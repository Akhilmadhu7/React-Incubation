    ...
    <div>
        ...
        <nav className="bg-indigo-800 flex rounded-md mb-2 justify-between">
                ...
                <div className='my-4 mx-6 flex'>
                    ...
                    <button onClick={logoutAdmin} className=' w-full px-2 py-1 tracking-wide bg-slate-200 font-medium transition-colors duration-200 transform bg-white-700 rounded-md hover:bg-violet-50 hover:text-red-600 focus:outline-none '>
                    Logout
                    </button>
                </div>
